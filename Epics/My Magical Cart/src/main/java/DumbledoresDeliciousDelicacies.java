...
//        1.Capture input to see if there is customer, else quit
//        2.Welcome customer and ask if they want to answer challenge question
//        3.If yes, then show question
//        4.If Correct then show updated prices
//        5.Wrong say things and note the 10% penalty fee
//        6.Show Prices and items
//        7.Ask what they want
//        8.Keep using the while loop until they say 4 and checkout
//        9.If they do the same item a second time override it, do not add
//        10.When checked out:
//        11.Show only what they have order and the amount
//        12.Show total price on the bottom
//        13.Show 10% off or fee if tried to answer question
//        14.Ask how they will pay
//        15.Calculate to see if the change is over 20 galleons
//        16.If they did not pay enough, while loop until they have paid the correct amount
//        17.Show change if need else thank them for correct amount
//        18.Ask if anyone else is waiting to order
//        19.If yes then go to step one and go down
//        20. Else End
...
public class DumbledoresDeliciousDelicacies {
        ...
        while (yes.equals("Yes") || yes.equals("yes")) {
            ...
            if (userCur == 1) {
                ...
                while (userAmount < amountTotal) {
                    ...
                    System.out.println("That is not enough, please enter the correct amount.");
                    userAmount = userInput.nextInt();
                    userInput.nextLine();
                    over = amountTotal - userAmount;
